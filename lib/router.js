...
BestDiscussionsListController = DiscussionsListController.extend({
  ...
  nextPath: function() {
    return Router.routes.bestDiscussions.path({discussionsLimit: this.discussionsLimit() + this.increment});
  }
});
...
/*Router.route('/new/:discussionsLimit?', {name: 'newDiscussions'});
Router.route('/best/:discussionsLimit?', {name: 'bestDiscussions'});*/
