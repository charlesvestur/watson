...
Router.map(function () {
  ...
  path: '/mainResults/new/:discussionsLimit?/:hashtag?', //Le ? indique que le paramètre 'discussionsLimit' est optionnel
  ...
  path: '/mainResults/best/:discussionsLimit?/:hashtag?', //Le ? indique que le paramètre 'discussionsLimit' est optionnel
